...
<>
    ...
    <div class="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
        <img class="w-full   dark:hidden" src={euphoriacheck} alt="dashboard image" />
        <img class="w-full hidden dark:block" src={euphoriacheck} alt="dashboard image"/>
        <div class="mt-4 md:mt-0">
            <h2 class="mb-4 font-extrabold text-3xl sm:text-3xl tracking-tight ">EuphoriaCheck </h2>
            ...
            <a href="#" class="inline-flex items-center text-white bg-indigo-600 hover:bg-primary-800 focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5 text-center ">
                View Project
